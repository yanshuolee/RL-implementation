...
ps_0 = np.load('./results/{}/planning_step_0.npy'.format(folder))
ps_5 = np.load('./results/{}/planning_step_5.npy'.format(folder))
ps_10 = np.load('./results/{}/planning_step_10.npy'.format(folder))
ps_50 = np.load('./results/{}/planning_step_50.npy'.format(folder))
